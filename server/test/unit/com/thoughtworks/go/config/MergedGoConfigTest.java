...
public class MergedGoConfigTest extends CachedGoConfigTestBase {
    ...
    public void shouldDelegateWritePipelineConfigCallToFileService(){
        ...
        when(fileService.writePipelineWithLock(pipelineConfig, holderBeforeUpdate, saveConditions, user)).thenReturn(saveResult);

        mergedGoConfig.writePipelineWithLock(pipelineConfig, saveConditions, user);
        ...
        verify(fileService).writePipelineWithLock(pipelineConfig, holderBeforeUpdate, saveConditions, user);
    }
}
