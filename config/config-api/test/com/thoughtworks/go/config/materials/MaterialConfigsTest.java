...
*/
    ...
    public void shouldValidateTree(){
        ...
        materialConfigs.validateTree(PipelineConfigSaveValidationContext.forChain(pipelineConfig));
    ...
    public void shouldFailValidationInNoMaterialPresent(){
        MaterialConfigs materialConfigs = new MaterialConfigs();
        assertThat(materialConfigs.validateTree(PipelineConfigSaveValidationContext.forChain(new PipelineConfig())), is(false));
